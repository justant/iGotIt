...
public class RecordingService extends Service {
	...
	private Notification createNotification() {
		...
		builder.setSmallIcon(R.drawable.speech_ic_action_mic_out_light);
		builder.setOngoing(true);

		builder.setContentIntent(PendingIntent.getActivities(getApplicationContext(), 0,
				new Intent[] { new Intent(getApplicationContext(), SpeechActivity.class) }, 0));
		...
		builder.addAction(R.drawable.speech_ic_stat_stop, getString(R.string.stop),
