...
public class DrawerMenuArrayAdapter extends ArrayAdapter<String> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		switch (position) {
		case SETTINGS_POS:
			drawableId = R.drawable.speech_ic_action_settings;
			break;
		case ABOUT_POS:
			drawableId = R.drawable.speech_ic_action_about;
			break;
		}

		int listItemResourceId;
		if (drawableId == 0) {
			listItemResourceId = R.layout.speech_drawer_list_item;
		} else {
			listItemResourceId = R.layout.speech_drawer_small_list_item;
		}
