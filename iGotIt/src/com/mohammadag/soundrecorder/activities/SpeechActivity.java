...
public class SpeechActivity extends Activity implements OnAudioLevelChangedListener, OnItemClickListener {
	...
	private ServiceConnection mConnection = new ServiceConnection() {
		public void onServiceConnected(ComponentName className, IBinder service) {
			...
			mRecordingService.setOnAudioLevelChanged(SpeechActivity.this);
			if (mRecordingQueued) {
	...
	private void doBindService() {
		bindService(new Intent(SpeechActivity.this, 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			mRecordingControlsFragment.setRecordButtonCallback(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					case IDLE:
						...
						MediaPlayer openPlayer = MediaPlayer.create(getApplicationContext(), R.raw.speech_open);
						if (openPlayer == null) {
							startRecording();
						} else {
					...
					default:
						...
						MediaPlayer successPlayer = MediaPlayer.create(getApplicationContext(), R.raw.speech_success);
			...
			transaction.add(R.id.container_holder, mRecordingControlsFragment);
	...
	private void switchToRecordings() {
		FragmentTransaction transaction = getFragmentManager().beginTransaction();
		removeAllFragments(transaction);
		transaction.add(R.id.container_holder, getRecordingsListFragment());
		transaction.commit();
	}
