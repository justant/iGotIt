...
public class FragmentCourseDirectory extends Fragment {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		CourseDirectoryViewPagerAdapter adapter = new CourseDirectoryViewPagerAdapter(getChildFragmentManager());
